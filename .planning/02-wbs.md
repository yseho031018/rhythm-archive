...
| 3.1 | 기록 흐름 | 기분, 키워드, 만족도, 이전 이동·선택 유지, 한 줄 생성 | 완료 | `record_screen.dart` |
...
| 4.2 | 감정잔디 | 월간·연간 보기, 날짜별 기분, 빈 날짜 기록 | 완료 | `mood_grass_screen.dart` |
...
| 6.2 | 통합 테스트 | 기록 흐름, 이전 이동, 월간·연간 잔디, 날짜·통계 화면 | 완료 | `test/` |
| 6.3 | 빌드·배포 | Web Release, GitHub Pages, URL 확인 | 완료 | `docs/deploy.md` |
| 7.1 | 문서화 | README, AGENTS, setup/deploy/testing | 완료 | 저장소 문서 |
| 7.2 | 최종 발표 | 5분 자료, 4분30초 대본, Q&A | 완료 | 발표자료·대본 |
| 7.3 | 시연 | 30초 사용자 시나리오 영상 | 완료 | MP4 |
...
gantt
  ...
  section 품질·발표
  테스트·문서·배포            :done, quality, 2026-06-13, 2d
  발표자료·시연·리허설        :done, present, 2026-06-14, 2d
