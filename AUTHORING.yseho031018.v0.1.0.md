...
Rhythm은 사용자가 매일의 감정, 에너지, 활동을 짧게 기록하고 이를 Wave Graph로 시각화하는 모바일 다이어리 앱이다. 기록을 단순한 텍스트 목록이 아니라 감정의 흐름과 생활 리듬을 볼 수 있는 시각적 경험으로 만드는 것을 목표로 한다.
...
- **시각화:** CustomPainter 기반 Wave Graph
